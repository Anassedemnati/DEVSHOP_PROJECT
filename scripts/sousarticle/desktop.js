...
var desktoparticle = [12, 16, 14, 13, 20, 7];

function testarticle(code) {
    for (let index = 0; index < desktoparticle.length; index++) {
        if (desktoparticle[index] == code) {
            return true;
        }
...
function chargerArticles() {
    ...
    for (var i = 0; i < catalogue.length; i++) {
        if (testarticle(catalogue[i].code)) {
